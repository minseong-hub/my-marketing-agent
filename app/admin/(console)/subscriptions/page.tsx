  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <Card className="p-5">
          <div className="text-sm font-semibold text-slate-500 mb-1">활성 MRR</div>
          <div className="text-3xl font-extrabold text-slate-900">₩{mrr.toLocaleString()}</div>
        </Card>
        <Card className="p-5">
          <div className="text-sm font-semibold text-slate-500 mb-1">연체</div>
          <div className="text-3xl font-extrabold text-slate-900">{pastDue}</div>
        </Card>
        <Card className="p-5">
          <div className="text-sm font-semibold text-slate-500 mb-1">해지</div>
          <div className="text-3xl font-extrabold text-slate-900">{canceled}</div>
        </Card>
      </div>
