  ...
  return (
    <div style={{ minHeight: "100vh", background: "#060920", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", position: "relative", padding: 32 }}>
      ...
      <div className="relative z-10 text-center flex flex-col items-center gap-6">
        {/* Broken gauges */}
        <p style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: 9, color: "#4a5a8a", letterSpacing: "0.1em" }}>
          SECTOR_???? · LOST IN SPACE
        </p>
        ...
        <div style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: 10, color: "#7e94c8", lineHeight: 1.8 }}>
          <p>이 좌표에는 아무것도 없습니다.</p>
          <p style={{ fontSize: 8, color: "#4a5a8a", marginTop: 4 }}>신호 없음 (NO SIGNAL)</p>
        </div>

        <div className="flex gap-3">
          <Link href="/" style={{ textDecoration: "none" }}>
            <PixelButton variant="primary" size="md">▶ 함선으로 귀환</PixelButton>
          </Link>
          <Link href="/crew" style={{ textDecoration: "none" }}>
            <PixelButton variant="secondary" size="md">크루 찾기</PixelButton>
          </Link>
        </div>
      </div>
    </div>
