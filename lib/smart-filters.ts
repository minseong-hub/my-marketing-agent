...
export function getSmartGroups(contents: ContentItem[]): SmartGroup[] {
  return [
    ...
    },
    {
      ...
      href: "/app/contents?templateType=member_benefit",
      color: "violet",
      iconLabel: "회원",
    },
    {
      ...
      href: "/app/contents?platform=openchat&status=scheduled",
      color: "amber",
      iconLabel: "채팅",
    },
    {
      ...
      href: "/app/contents?status=drafting",
      color: "rose",
      iconLabel: "검토",
    },
  ];
