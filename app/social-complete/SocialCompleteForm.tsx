      ...
      <div className="relative z-10 flex-1 flex items-start justify-center px-4 py-8">
        <div className="w-full max-w-md">
          <div className="text-center mb-5">
            <div className="inline-flex items-center gap-1.5 text-sm font-medium text-white/80 bg-white/10 border border-white/20 px-3 py-1.5 rounded-full mb-3">
              <CheckCircle2 className="w-3.5 h-3.5 text-emerald-300" />
              {PROVIDER_LABEL[provider]} 연동 완료
            </div>
            <h1 className="text-2xl font-extrabold text-white mb-1">프로필을 완성해주세요</h1>
            <p className="text-base text-blue-100/70">{email}</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-xl p-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <Label className="text-base font-medium text-white/80">휴대폰번호</Label>
                <Input
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center">
                  <span className="px-3 bg-transparent text-sm text-white/40 font-medium">브랜드 정보</span>
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                <Label className="text-base font-medium text-white/80">
                  상호명 <span className="text-sm text-white/40 font-normal ml-1">(사업자 등록 상호)</span>
                </Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label className="text-base font-medium text-white/80">
                  브랜드 표시명 <span className="text-sm text-white/40 font-normal ml-1">(앱 전역에 표시)</span>
                </Label>
                <Input
                  placeholder="예: 홍길동샵"
              ...
              {/* 비즈니스 유형 */}
              <div className="space-y-1.5">
                <Label className="text-base font-medium text-white/80">비즈니스 유형</Label>
                <select
                  value={form.businessType}
                  onChange={(e) => setForm({ ...form, businessType: e.target.value })}
                  required
                  className="w-full h-10 rounded-xl px-3 text-base bg-white/10 border border-white/20 text-white focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400/40 [&>option]:bg-blue-900 [&>option]:text-white"
                >
              ...
              {/* 업종 */}
              <div className="space-y-1.5">
                <Label className="text-base font-medium text-white/80">업종</Label>
                <select
                  value={form.industry}
              ...
              <div className="space-y-2">
                <Label className="text-base font-medium text-white/80">
                  주요 판매 채널 <span className="text-sm text-white/40 font-normal ml-1">(선택, 복수 선택 가능)</span>
                </Label>
              ...
              <div className="space-y-1.5">
                <Label className="text-base font-medium text-white/80">
                  대표 상품군 <span className="text-sm text-white/40 font-normal ml-1">(선택)</span>
                </Label>
                <Input
              ...
              <button
                ...
                className="w-full h-11 bg-white text-blue-700 hover:bg-blue-50 font-semibold rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-base mt-1"
              >
